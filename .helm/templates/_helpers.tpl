...
{{- if .Values.rbac.clusterRole.dataRouteViewer.nameOverride }}
{{- .Values.rbac.clusterRole.dataRouteViewer.nameOverride }}
{{- else }}
{{- printf "%s-dataroute-viewer" (include "app.fullname" .) }}
{{- end }}
{{- end }}
